...
<p align="center" style="padding-top: 20px;"><a href="http://www.youtube.com/user/ETRPubs?feature=watch" target="_blank"><img alt="YouTube" src="/root/assets/Image/footer-socialMedia_youTube.png" style="width: 68px; height: 55px;" /></a><a href="https://www.facebook.com/ETRAssociates" target="_blank"><img alt="Facebook" src="/root/assets/Image/footer-socialMedia_facebook.png" style="width: 64px; height: 55px;" /></a><a href="http://twitter.com/etrassociates" target="_blank"><img alt="Twitter" src="/root/assets/Image/footer-socialMedia_twitter.png" style="width: 56px; height: 55px;" /></a><a href="http://www.linkedin.com/company/etr-associates" target="_blank"><img alt="LinkedIn" src="/root/assets/Image/footer-socialMedia_linkedIn.png" style="width: 66px; height: 55px;" /></a></p>
  ...
  <footer class="noprint">
        <div class="row-fluid">
	      		<div class="span2"> <a href="http://www.etr.org"><img src="/root/assets/Image/etrLogo.png" style="width: 135px; height: 114px; padding: 40px 20px 0 20px;" alt="ETR: Advancing Science - Reducing Risk - Improving Lives" /></a></div>
                
                <div class="span2"><p style="padding-top: 40px">100 Enterprise Way, <br>
                  Suite G300<br />
	Scotts Valley, CA 95066<br />
	<i class="icon-globe"></i> <a href="http://www.etr.org">www.etr.org</a><br />

    <i class="icon-envelope"></i> <a href="mailto:customerservice@etr.org">Email Support</a><br />
    <i class="icon-twitter-sign"></i> <a href="https://twitter.com/ETRASSOCIATES" target="_blank">@ETRAssociates</a><br />
    <i class="icon-facebook-sign"></i> <a href="https://www.facebook.com/ETRassociates" target="_blank">Like Us</a><br /></p>
...
<p align="right"><cfif $.currentUser().isLoggedIn()>
 			<a href="?doaction=logout">Logout</a>
				<cfelse>
					<a href="/admin">Login</a>
				</cfif> | <a href="##">Back to top</a></p>
