...
<cfoutput>
 ...
 <script>   
    ...
    <!-- OLD ANALYTICS CODE
    <!--- KJ 5/16/13 GOOGLE ANALYTICS CODE
	========================================= 
	This is set to include both the new site and the old --->
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-718413-7']);
  ...
  (function() {
    ...
    <!--- CK 3/13/15 GOOGLE ANALYTICS CODE
	========================================= 
	This is set to include both the new site and the old --->
